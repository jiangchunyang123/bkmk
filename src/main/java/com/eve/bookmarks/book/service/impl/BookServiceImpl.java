package com.eve.bookmarks.book.service.impl;
...
public class BookServiceImpl implements IBookService {
    ...
    public void saveOrUpdate(Book book) {
        if (book.getId() != null) {
            ...
            stringObjectMap.put("bar_code", book.getBarCode());
    ...
    @Override
    public Page<Book> search(String name,String barCode, Integer pageSize, Integer pageNum) {
        Integer count = bookMapper.booksCount(name,barCode);
        List<Book> books = bookMapper.books(name,barCode, pageSize, pageNum * pageSize);
        books.forEach((book) -> {
